  ...
  <div class="veinte">
    ...
    <div class="mil">
      <div class="doscientos">
        <div class="cien">
          <div class="veinte">
            <i class="fas fa-female" style="color:#6b1111"></i><i class="fas fa-female"style="color:#6b1111"></i><i class="fas fa-female"style="color:#6b1111"></i><i class="fas fa-female"style="color:#6b1111"></i><i class="fas fa-female"style="color:red"></i><i class="fas fa-female"style="color:red"></i><i class="fas fa-female"style="color:red"></i><i class="fas fa-female"style="color:red"></i><i class="fas fa-female"style="color:red"></i><i class="fas fa-female"style="color:red"></i><i class="fas fa-female"style="color:red"></i><i class="fas fa-female"style="color:red"></i><i class="fas fa-female"style="color:red"></i><i class="fas fa-female"style="color:red"></i><i class="fas fa-female"style="color:red"></i><i class="fas fa-female"style="color:red"></i><i class="fas fa-female"style="color:red"></i><i class="fas fa-female"style="color:red"></i><i class="fas fa-female"style="color:red"></i><i class="fas fa-female"style="color:red"></i>
          </div>
          <div class="veinte">
            <i class="fas fa-female" style="color:red"></i><i class="fas fa-female"style="color:red"></i><i class="fas fa-female"></i><i class="fas fa-female"></i><i class="fas fa-female"></i><i class="fas fa-female"></i><i class="fas fa-female"></i><i class="fas fa-female"></i><i class="fas fa-female"></i><i class="fas fa-female"></i><i class="fas fa-female"></i><i class="fas fa-female"></i><i class="fas fa-female"></i><i class="fas fa-female"></i><i class="fas fa-female"></i><i class="fas fa-female"></i><i class="fas fa-female"></i><i class="fas fa-female"></i><i class="fas fa-female"></i><i class="fas fa-female"></i>
          </div>
